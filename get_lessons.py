...
def get_all_lessons():
    ...
    while True:
        ...
        these_lessons = jsonObj["lessons"]

        for data in these_lessons:
            all_lessons.append(json.dumps(data))
    ...
    # print("Total number of lessons is " + str(len(all_lessons)))
    for i, data in enumerate(all_lessons):
